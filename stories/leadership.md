...
<ul class="filter-pills">
  ...
  <li><a href="{{ '/stories/leadership' | relative_url }}" aria-current="page">Leadership</a></li>
  <li><a href="{{ '/stories/conference' | relative_url }}">Conference</a></li>
  <li><a href="{{ '/stories/isd' | relative_url }}">ISD</a></li>
</ul>

{% assign filtered = site.posts | where: "category", "Leadership" %}
{% if filtered.size == 0 %}
<p class="empty-state">No Leadership stories yet.</p>
{% else %}
<ul class="story-list">
