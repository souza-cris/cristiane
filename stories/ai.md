...
<ul class="filter-pills">
  ...
  <li><a href="{{ '/stories/ai' | relative_url }}" aria-current="page">AI</a></li>
...
{% assign filtered = site.posts | where: "category", "AI" %}
{% if filtered.size == 0 %}
<p class="empty-state">No AI stories yet.</p>
{% else %}
<ul class="story-list">
