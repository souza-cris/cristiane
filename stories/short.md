...
<ul class="filter-pills">
  ...
  <li><a href="{{ '/stories/short' | relative_url }}" aria-current="page">short</a></li>
...
{% assign filtered = site.posts | where: "length", "short" %}
{% if filtered.size == 0 %}
<p class="empty-state">No short stories yet.</p>
{% else %}
<ul class="story-list">
