...
{% assign filtered = site.posts | where: "length", "long" %}
{% if filtered.size == 0 %}
<p class="empty-state">No long stories yet.</p>
{% else %}
<ul class="story-list">
