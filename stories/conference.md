...
<ul class="filter-pills">
  ...
  <li><a href="{{ '/stories/conference' | relative_url }}" aria-current="page">Conference</a></li>
  <li><a href="{{ '/stories/isd' | relative_url }}">ISD</a></li>
</ul>

{% assign filtered = site.posts | where: "category", "Conference" %}
{% if filtered.size == 0 %}
<p class="empty-state">No Conference stories yet.</p>
{% else %}
<ul class="story-list">
